...
export async function GET() {
  ...
  if (error) return errorResponse('INTERNAL_ERROR', 'Failed to fetch services', 500, error.message)
...
export async function POST(request: Request) {
  ...
  if (error) return errorResponse('INTERNAL_ERROR', 'Failed to create service', 500, error.message)
