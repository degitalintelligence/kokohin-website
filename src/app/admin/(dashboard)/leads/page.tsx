...
export default async function AdminLeadsPage({
  ...
  const { data: projects } = await supabase
    .from('erp_projects')
    .select('id, status, estimations(total_selling_price, created_at, version_number)')
    .order('created_at', { ascending: false })
                          ...
                          <tr key={lead.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            ...
                            <td className="p-4 text-right">
                              {displayStatus === 'Need Manual Quote' ? (
                                ...
                                <Link href={`/admin/leads?view=costing_builder&lead=${lead.id}`} className="inline-flex items-center gap-1 text-xs font-bold text-gray-700 bg-gray-100 border border-gray-300 px-3 py-1.5 rounded hover:bg-gray-200 transition-colors">
                                  <FileEdit size={14} /> Edit Estimasi V2
                                </Link>
                              )}
                            </td>
                          </tr>
          ...
          {view === 'costing_builder' && (
            <div>
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-extrabold text-gray-900">Costing Builder <span className="text-gray-400 font-medium">| Estimasi V1</span></h2>
                ...
                <div className="space-y-6">
                  <div className="bg-[#1D1D1B] text-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div className="p-4 bg-gray-900">
                      {/* Project ID untuk PDF generation - menggunakan project pertama atau null */}
